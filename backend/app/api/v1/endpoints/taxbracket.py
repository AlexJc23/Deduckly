...
from app.services.bracket_service import create_tax_brackets, get_tax_brackets, update_tax_bracket, delete_tax_bracket
...
def create_tax_brackets_endpoint(
    ...
    return create_tax_brackets(db, brackets_in, current_user)
